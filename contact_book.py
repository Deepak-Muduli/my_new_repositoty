...
choice = input("Do You Want To Add or Delet :  ")
...
if choice.lower() =="add":
    ...
    while True:
        ...
        choice1 = input("Do You want to add more (yes/no)")
    ...
    while True :
        ...
        count = num+1
        delet = input("Enter Name you Want To Delet Contact : ")
...
search_item = input("Enter The Search Tearm ")
